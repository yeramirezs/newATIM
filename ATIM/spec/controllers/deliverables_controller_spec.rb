  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deliverable as @deliverable" do
        ...
        post :create, {:deliverable => { "title" => "invalid value" }}, valid_session
        assigns(:deliverable).should be_a_new(Deliverable)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deliverable" do
        ...
        Deliverable.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => deliverable.to_param, :deliverable => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deliverable as @deliverable" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deliverable.any_instance.stub(:save).and_return(false)
        put :update, {:id => deliverable.to_param, :deliverable => { "title" => "invalid value" }}, valid_session
        assigns(:deliverable).should eq(deliverable)
      end
